      ...
      <div className="flex lg:flex-row items-center flex-col text-center justify-evenly p-5 bg-[#31363F] gap-4">
        <div className="flex flex-col gap-4">
          ...
          <p>
            ...
            navigating<br /> Step 1: Open Camera. <br />{" "}
            Step 2: Click Join Meeting.<br />Step 3: Enter room ID(Address) and
            join room
          </p>
        </div>
        <div>
      ...
      <div className="flex lg:flex-row items-center flex-col text-center justify-evenly p-5 bg-[#31363F] gap-4">
        <div className="flex flex-col gap-4">
          ...
          <p>
            ...
            open camera and you're good.<br />When the camera is open you should
            see something like this.{" "}
            <br />It's essential to open the camera before joining a meeting, if
            you don't want to be seen in the meeting, scroll down for
            instructions.
          </p>
        </div>
        <div>
      ...
      <div className="flex lg:flex-row items-center flex-col text-center justify-evenly p-5 bg-[#31363F] gap-4">
        <div className="flex flex-col gap-4">
          ...
          <p>
            ...
            off.<br />You're expected to see this when you do that.{" "}
            <br />Note that you can't join any meeting if you hit close camera,
            and if you're in a meeting and you hit close camera you'd exit the
            meeting
          </p>
        </div>
        <div>
  ...
  return (
    <>
      ...
      <div>
        ...
        <p>
          ...
          meeting ID of the meeting you are about to start/join then press Join
          Room.
          <br />
          This room id is what the creator of the meeting chooses as his/her room id, it can be anything the person wants.
          <br />
          Once there are 2 or more participants in a room, the participants slides shows up.
          You can double click on a certain user's video to see it in full screen
        </p>
      </div>
      <div>
    ...
    <div className="flex lg:flex-row items-center flex-col text-center justify-evenly p-5 bg-[#31363F] gap-4">
      <div>
        ...
        <p>
          Here you have clicked join room, and another user has also joined (i am meeting with myself in another window).
          this is what it should look like.
          <br />
          The icons down, the mic and the cam, represent's the current state of the participant, to know if the participant is muted, or turns off his/her video.
          
          <br />
          To leave the meeting, just click the red icon, which says leave room, that helps you exit
        </p>
      </div>
      <div>
    ...
    <>
     <div className="flex lg:flex-row items-center flex-col text-center justify-evenly p-5 bg-[#31363F] gap-4">
       <div>
        ...
        <p>That's the chat box, where you can send messages to everyone in the meeting and also recieve messages in real time.
          <br /> Sending messages is relatively easy, just typing your message and hit enter or click the send icon
        </p>
       </div>
       <div>
